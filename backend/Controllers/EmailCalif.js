...
async function queryforEmail(mes, anio) {
  ...
  try {
    const queryForEmail = `SELECT company_email, full_name, exam_calif, time ,first_exam FROM evaluation_data WHERE month = ? AND first_exam LIKE ? AND company = 'Volaris'`;
